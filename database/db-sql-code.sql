...
/* Creating reference between inventory and classification table */
...
/* Saved favorites - week 6 enhancement */
...
(
    ...
    CONSTRAINT account_favorite_unique UNIQUE (account_id, inv_id),
    CONSTRAINT account_favorite_account_fk FOREIGN KEY (account_id)
        REFERENCES public.account (account_id) ON DELETE CASCADE,
    CONSTRAINT account_favorite_inventory_fk FOREIGN KEY (inv_id)
